    ...
    <div class="row align-items-center mt-5">
        ...
        <div class="col-md-6">
            <form action="{{route('register')}}" method="post" class="" style="padding: 40px; border-radius: 2%; background-color: whitesmoke ">
                @csrf
                <h3 class="text-center h2" style="font-family: 'Inconsolata', monospace;">Registration Form</h3>
                @if ($errors->any())
                ...
                <button type="submit" style="font-family: 'Inconsolata', monospace;" class="btn btn-primary">Register</button>
            </form>
        </div>
    </div>
</div>
